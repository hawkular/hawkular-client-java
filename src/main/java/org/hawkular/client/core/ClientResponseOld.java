...
public class ClientResponseOld<T> implements ClientResponse<T> {
    ...
    public ClientResponseOld(Class<?> clazz, Response response, int statusCode) {
        this(clazz, null, response, statusCode, null, null);
    }

    public ClientResponseOld(Class<?> clazz, Class<?> parametrizedClazz, Response response, int statusCode) {
        this(clazz, parametrizedClazz, response, statusCode, null, null);
    }

    public ClientResponseOld(Class<?> clazz, Response response, int statusCode, String tenantId) {
        this(clazz, null, response, statusCode, tenantId, null);
    }

    public ClientResponseOld(Class<?> clazz, Response response, int statusCode, boolean isEntityList) {
        this(clazz, null, response, statusCode, null, isEntityList == true ? List.class : null);
    }

    public ClientResponseOld(Class<?> clazz, Class<?> parametrizedClazz, Response response, int statusCode, boolean isEntityList) {
        this(clazz, parametrizedClazz, response, statusCode, null, isEntityList == true ? List.class : null);
    }

    public ClientResponseOld(Class<?> clazz, Response response, int statusCode, String tenantId, boolean isEntityList) {
    ...
    public ClientResponseOld(Class<?> clazz, Class<?> parametrizedClazz, Response response, int statusCode, String tenantId,
